...
# Base dataset directory (single dataset with 'Fake' and 'Real' subfolders)
base_dataset_dir = 'E:/498R/Dataset3'
...
# Process the dataset (since you have only training data)
dataset_dir = Path(base_dataset_dir)
...
output_dir = 'E:/498R/Code/Result/Dataset3'
save_data(features, labels, output_dir, 'dataset3_full')
